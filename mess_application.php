...
<head>
    ...
    <title>Mess Payment Application</title>
...
<body class="bg-gray-100 h-screen flex items-center justify-center">
    ...
    <div class="container mx-auto mt-12 p-8 bg-white max-w-md rounded-md shadow-md">
        <h2 class="text-2xl font-bold mb-6">Mess Payment Application</h2>

        <form action="include/process_application.php" method="post">
            <input type="hidden" name="type" value="mess_payment" class="hidden">
